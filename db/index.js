...
mongoose
.connect('mongodb://localhost:27017/flightsDatabase')
.then(() => {
    console.log('successfully connected to flightsDatabase')
})
.catch((e) => {
    console.error('connection error', e.message)
})
// when we run our queries, we'll see our raw command line in the terminal
